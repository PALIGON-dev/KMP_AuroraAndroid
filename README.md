KMP_AuroraAndroid
Приложение, созданное на базе Kotlin Multiplatform (KMP), предназначено для демонстрации работы
общего кода между платформами Aurora OS и Android. Проект показывает базовые принципы использования
общих модулей, а также реализацию UI отдельно для каждой платформы.
